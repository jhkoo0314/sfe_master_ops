...
- `docs/architecture/01_current_state_audit.md` 작성
- `docs/architecture/07_sales_data_os_architecture.md` 작성
- `docs/architecture/02_refactor_plan_sales_data_os.md` 작성
