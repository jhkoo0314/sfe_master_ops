...
class CrmStandardActivity(BaseModel):
    ...
    activity_type: str = Field(..., description="활동 유형 표준값 (8대 행동: PT/Demo/Closing/Needs/FaceToFace/Contact/Access/Feedback)")
    activity_type_raw: Optional[str] = Field(None, description="원본 활동 유형 값")
    activity_type_standard: Optional[str] = Field(None, description="표준화된 활동 유형 값")
