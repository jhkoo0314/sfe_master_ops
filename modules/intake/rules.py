...
_STANDARD_RULES: dict[str, IntakeRule] = {
    "crm_activity": IntakeRule(
        ...
        field_aliases={
            "activity_date": ("activity_date", "visit_date", "방문일", "활동일", "date"),
            "rep": ("rep_id", "rep_name", "담당자", "담당자명", "사원명"),
            "account": ("hospital_id", "hospital_name", "account_id", "병원코드", "병원명", "거래처명"),
            "activity_type": ("activity_type", "활동유형", "activity", "call_type"),
    ...
    "crm_rep_master": IntakeRule(
        ...
        review_fields=("role",),
        field_aliases={
            "rep": ("rep_id", "rep_name", "담당자id", "담당자명", "사원번호", "사원명"),
            "organization": ("branch_name", "team_name", "조직", "지점", "팀", "부서"),
            "role": ("role", "직무", "직책"),
        },
    ),
    "crm_account_assignment": IntakeRule(
        ...
        field_aliases={
            "account": ("hospital_id", "hospital_name", "account_id", "병원코드", "병원명", "거래처명"),
            "rep": ("rep_id", "rep_name", "담당자id", "담당자명", "사원명"),
        },
    ),
    ...
    "sales": IntakeRule(
        ...
        field_aliases={
            "account": ("hospital_id", "hospital_name", "account_id", "병원코드", "병원명", "거래처명"),
            "product": ("product_id", "product_name", "품목코드", "품목명", "제품명"),
            "amount": ("sales_amount", "amount", "매출", "매출액", "금액"),
            "period": ("yyyymm", "sales_month", "month", "매출월", "월"),
            "rep": ("rep_id", "rep_name", "담당자", "사원명"),
        },
    ),
    "target": IntakeRule(
        source_key="target",
        ...
        field_aliases={
            "period": ("yyyymm", "target_month", "month", "목표월", "월"),
            "target_value": ("target_amount", "target_qty", "목표금액", "목표수량", "목표"),
    ...
    "prescription": IntakeRule(
        ...
        field_aliases={
            "ship_date": ("ship_date", "date", "출고일", "납품일"),
            "pharmacy": ("pharmacy_name", "약국명", "약국", "customer_name"),
            "product": ("product_id", "product_name", "품목명", "제품명"),
            "quantity": ("qty", "quantity", "수량", "출고수량"),
            "hospital": ("hospital_name", "병원명", "account_name"),
            "amount": ("amount", "sales_amount", "공급가액", "출고금액"),
        },
    ),
}
